...
SECRET_KEY = 'django-insecure-f&ja+e8b2-h$^ic_axpobxm&&ovnfh-v5pyb2%gy+r4yevpxd6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'portafoliojuan.up.railway.app',
    'localhost',
    '127.0.0.1',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/ 'PortafolioTemplate/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join (BASE_DIR, 'PortafolioTemplate')  # Carpeta estática existente
]
...
CSRF_TRUSTED_ORIGINS = ['https://portafoliojuan.up.railway.app']
